        ...
        return(
            <div className="headerImage">
                ...
                <h2 className="d-none d-sm-block text--huge">
                    <span className="text--red text--bold">STRICTLY LIMITED SEASON</span> <br className="d-xl-none"/> FROM 6 SEPTEMBER 2019
                    <br/>
                    <span className="text--big text--bold"> FOR 9 WEEKS ONLY<br className="d-xl-none"/> AT THE DOMINION THEATRE</span>
                </h2>

                <h2 className="d-block d-sm-none text--big">
                    <span className="text--red text--bold">STRICTLY LIMITED SEASON</span><br/>FROM 6 SEPTEMBER 2019
                    <br/>
                    <span className="text--basic letter-spacing--1"> FOR 9 WEEKS ONLY AT THE DOMINION THEATRE</span>
                </h2>
            </div>
        )
    }
