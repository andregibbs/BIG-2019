...
import makeAWish from '../images/make-a-wish.svg'
                ...
                <section className="page HomePage">
                    <div className="HomePage--content">
                        <Container fluid={true} className="container--gray py-4">
                            <Container>
                                <p className="text--smaller">“BIG” Written by Gary Ross and Anne Spielberg. A Twentieth Century Fox Film.<br/><br className="d-sm-none"/><br className="d-sm-none"/>
                                    Book by <span className="text--basic text-uppercase">John Weidman</span>   Music by <span className="text--basic text-uppercase">David Shire</span>   Lyrics by <span className="text--basic text-uppercase">Richard Maltby</span></p>
                        ...
                        <Container fluid={true} className="container--dark-gray py-4">
                            <Container>
                                <ul className="button-list">
                                    <li><a href="#" target="_blank" rel="noreferrer noopener" className="btn btn--red">Book online</a></li>
                                    <li><a href="tel:+443452007892" target="_blank" rel="noreferrer noopener" className="btn btn--red">call 0345 200 7892</a></li>
                                    <li><a href="https://www.google.com/maps/place/Dominion+Theatre/@51.5167185,-0.1323594,17z/data=!3m1!4b1!4m5!3m4!1s0x48761b2d6954b527:0xa11d7ff34a8e1347!8m2!3d51.5167185!4d-0.1301707" target="_blank" rel="noreferrer noopener" className="btn btn--red">Book in person*</a></li>
                                </ul>
                                ...
                                <ul className="button-list mt-4">
                                    <li>
                                        ...
                                        <p className="text--bold">Groups 10+ tickets just £45* </p>
                                        <p className="text-uppercase">BOOK AND PAY BY 23 JULY </p>
                                        <p><span className="text--bold">10+ tickets:</span> £37.50 each | <span className="text--bold">25+ tickets:</span> £32.50 each </p>
                                        <p className="text-uppercase">From 24 July</p>
                                        <p> <span className="text--bold">10+ tickets:</span> £42.50, <span className="text--bold">25+ tickets:</span> £37.50 each</p>
                                        <div className="mt-4">
                                            <a href="#" target="_blank" rel="noreferrer noopener" className="btn btn--red">Book now</a>
                                        </div>
                                    </li>
                                    <li>
                                        <h3 className="text-uppercase">Groups save!</h3>
