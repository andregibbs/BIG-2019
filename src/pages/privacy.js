...
const headData = {
    title: 'Privacy | White Christmas | Official Site',
    description: 'The privacy policy for the official website for Irving Berlin’s WHITE CHRISTMAS The Musical at the Dominion Theatre from 15 November 2019 – 4 January 2020.',
};
...
const Privacy = () => (
    <Layout headData={headData}>
        <Container className="pt-5 mt-5 page">
            ...
            <h4>Introduction</h4>
            <p>This website, controlled by White Christmas Theatre Ltd provides marketing information about White Christmas. White Christmas Theatre Ltd is the Data Controller, for the purposes of Data Protection Law, when your personal information is processed as a result of your visit to this website.</p>
            ...
            <p>This policy was last updated on 14/03/2019. Any future changes to our policy will be reflected here.</p>
            <h4>Contacting us </h4>
           <p>Questions, comments and requests regarding this privacy policy are welcomed and should be addressed by email to <a href="mailto:info@dewynters.com">info@dewynters.com</a> or by post to White Christmas Theatre Ltd, Jamie Wilson Productions Ltd, Theatre on the Fourth Floor, 1 Wardour Street, London, W1D 6PA</p>
            <h4>Why we process your personal information</h4>
            ...
            <h4>Tailoring this website to your needs</h4>
